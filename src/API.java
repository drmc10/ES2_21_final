...
public interface API {
    ...
    void requestBook(String hash, String userId) throws BookAlreadyLoanedException, BookDoesntExistException, UserDoesntExistException, RenewLimitExceeded, InvalidHashException;
