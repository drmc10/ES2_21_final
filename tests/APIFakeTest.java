...
public class APIFakeTest {
    ...
    public void testGetBookDataBase() throws MissingTitleException, IncorrectPageNumber, MissingPublisherException,
            InvalidFileSizeException, InvalidFileExtension, InvalidHashException, NullParameterException, TooFewCharsException, TooManyCharsException {
        ...
        ArrayList<Ebook> receivedList = BookDatabase.INSTANCE.getBookList();
    ...
    @Test
    public void testBlockUserIdBelow36() {
        Assertions.assertThrows(TooFewCharsException.class, () -> api.blockUser("12345678901234567890123456789012345"));
    }

    @Test
    public void testBlockUserIdAbove36() {
        Assertions.assertThrows(TooManyCharsException.class, () -> api.blockUser("1234567890123456789012345678901234567"));
    }

    @Test
    public void testBlockUserIdEmpty() {
        Assertions.assertThrows(MissingUserIdException.class, () -> api.blockUser(""));
    }

    @Test
    public void testBlockUserUserIdNull() {
        Assertions.assertThrows(NullParameterException.class, () -> api.blockUser(null));
    }

    @Test
    public void testBlockUserWrongId() {
        Assertions.assertThrows(UserDoesntExistException.class, () -> api.blockUser("123456789012345678901234567890123456"));
    }
